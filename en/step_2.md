...
Pathfinding games that use traps challenge your skills and make you think how to navigate the twists and turns. Overcoming hazards rewards players with a sense of accomplishment. This is nothing new. <span style="color: #0faeb0">**Trench Football**</span> was a popular wooden marble rolling game created in 1915 that used holes in the corners of turns along the pathway.
</p>
...
In the Inspector, click on the tag drop-down and choose **Add Tag…**. Add a new Tag called 'Tile'.

**Tip:** It doesn't matter which objects you have selected when you create a new tag. 

![A screenshot of the Inspector with tag drop-down and 'Add Tag' sub menu item highlighted.](images/tag-dropdown.png)

![A screenshot of the Tags and Layers window with the + icon highlighted and the word 'Title' typed in the 'New Tag Name' prompt.](images/new-tag.png)
...
**Choose:** Pick a start material for the tiles from the Materials folder. 
...
**Choose:** Select a material from the Materials folder and drag it onto the start platform in the Scene view.
